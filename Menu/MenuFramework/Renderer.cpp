...
void CDraw::CreateObjects()
{
    ...
    this->m_TabFont4 = AddFontMemResourceEx((void*)(RawData::TabIcons4), (DWORD)5192, nullptr, &nFonts5);
    ...
    D3DXCreateFontA(m_Device, 47, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, DRAFT_QUALITY, DEFAULT_PITCH, "gamesense", &Fonts::TabIcons4);
